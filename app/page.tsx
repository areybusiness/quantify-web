    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700">
      <div className="container mx-auto px-4 py-16">
        <section className="text-center mb-16 relative">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1518186285589-2f7649de83e0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80')] bg-cover bg-center opacity-10"></div>
          <div className="relative z-10 bg-gray-800 bg-opacity-70 p-8 rounded-lg">
            <h1 className="text-5xl font-bold mb-4 text-white">Welcome to Quantify</h1>
            <p className="text-2xl mb-8 text-gray-300">The future of object counting is here</p>
        ...
        <section id="what-is-quantify" className="mb-16 bg-gray-800 bg-opacity-70 p-8 rounded-lg">
          <h2 className="text-3xl font-semibold mb-4 text-gray-200">What is Quantify?</h2>
        ...
        <section id="how-it-works" className="mb-16 bg-gray-800 bg-opacity-70 p-8 rounded-lg">
          <h2 className="text-3xl font-semibold mb-4 text-gray-200">How Quantify Works</h2>
        ...
        <section id="faq" className="mb-16 bg-gray-800 bg-opacity-70 p-8 rounded-lg">
          <h2 className="text-3xl font-semibold mb-4 text-gray-200">FAQ</h2>
